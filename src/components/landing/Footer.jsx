      ...
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          <div>
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold text-white">DietLab</span>
            </div>
            <p className="text-sm text-gray-400">
              La plataforma líder para nutricionistas profesionales.
              Transforma tu práctica con tecnología inteligente.
            </p>
          </div>
          <div>
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-gray-400">
              &copy; 2024 DietLab. Todos los derechos reservados.
            </p>
